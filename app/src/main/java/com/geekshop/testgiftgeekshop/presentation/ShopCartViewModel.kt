package com.geekshop.testgiftgeekshop.presentation
...
import com.geekshop.testgiftgeekshop.domain.entity.*
...
//    val errorInputEntity: StateFlow<ErrorInputModel> = _errorInputEntity
    ...
    val novaPoshtaName by lazy {
        application.getString(com.geekshop.testgiftgeekshop.R.string.nova_poshta_name)
    }
    val ukrPoshtaName by lazy {
        application.getString(com.geekshop.testgiftgeekshop.R.string.ukrposhta_name)
    }
